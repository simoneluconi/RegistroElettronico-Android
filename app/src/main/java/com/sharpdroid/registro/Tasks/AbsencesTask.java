...
public class AbsencesTask {
    ...
    public Void update() {
        ...
        RESTFulAPI.get(mContext, /*RESTFulAPI.ABSENCES_URL*/ "https://gist.githubusercontent.com/luca020400/55f65db6a685dc2413f9ba7252c20cbf/raw/absences.json", null, new TextHttpResponseHandler() {
            @Override
